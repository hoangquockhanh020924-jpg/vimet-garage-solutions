...
export const newsArticles: NewsArticle[] = [
  {
    ...
    "excerpt": "Tổng quan nguyên lý làm việc, các thành phần chính (bơm, van, xy lanh, dầu thủy lực) và ứng dụng của hệ thống thủy lực trong cầu nâng, máy ép, thiết bị gara ô tô.",
    "category": "Kỹ thuật",
    "date": "26/04/2026",
  ...
  },
  {
    ...
    "excerpt": "Tổng hợp các dòng cầu nâng 1 trụ, 2 trụ, 4 trụ, cắt kéo được nhiều gara lựa chọn, kèm ưu nhược điểm và gợi ý ứng dụng cho từng quy mô xưởng.",
  ...
  },
  {
    ...
    "excerpt": "Phân tích các nguyên nhân khiến máy nén khí quá nhiệt – từ dầu bôi trơn, lọc gió đến tải vận hành – và quy trình khắc phục chuẩn để đảm bảo tuổi thọ máy.",
    "category": "Khí nén",
    "date": "21/04/2026",
  ...
  },
  {
    ...
    "excerpt": "Giải thích chi tiết cấu trúc cơ khí, cơ chế nâng hạ thủy lực và những điểm cần lưu ý khi chọn cầu nâng cắt kéo cho gara dịch vụ nhanh.",
    "category": "Cầu nâng ô tô",
    "date": "20/04/2026",
  ...
  },
  {
    ...
    "excerpt": "Quy trình khởi động, vận hành và kiểm soát an toàn cho hệ thống máy nén khí trong gara, kèm checklist hằng ngày dành cho kỹ thuật viên.",
    "category": "Khí nén",
    "date": "15/04/2026",
  ...
  },
  {
    ...
    "excerpt": "So sánh cấu trúc, hiệu suất và nguyên lý giữa hai dòng máy nén khí trục vít và piston để chọn đúng thiết bị cho nhu cầu sử dụng.",
    "category": "Khí nén",
    "date": "12/04/2026",
    "publishedAt": "2026-04-12",
    "readMinutes": 7,
    "author": "Vimet Tech Team",
    "image": "https://vimet.com.vn/wp-content/uploads/2026/04/So-sanh-may-nen-khi-truc-vit-va-piston-2.jpg-1-280x180.webp",
  ...
  },
  {
    ...
    "excerpt": "Các bước chuẩn để vận hành máy ra vào lốp an toàn, hạn chế hư hại mâm và lốp – kèm lưu ý cho từng loại xe du lịch và xe tải nhẹ.",
    "category": "Lốp xe",
    "date": "08/04/2026",
  ...
  },
  {
    ...
    "excerpt": "Danh sách dụng cụ cầm tay cần thiết cho xưởng dịch vụ: tuýp, cờ lê, kìm, súng vặn bu lông và phụ kiện đi kèm – tiêu chí chọn mua chuẩn nghề.",
    "category": "Dụng cụ",
    "date": "05/04/2026",
